...
public class HttpStuff extends AsyncTask<String, Integer, String> {
    ...
    final String classifierID = "8d6f49x128-nlc-828";
    final String username = "9c4f8348-21a6-4240-acdc-a44de7c735da";
    final String password = "TlvSROPpIyFD";
	...
	final String INTENT_SHOW_PRODUCTS = "show-products";
	final String INTENT_DENGUE_ASSIST = "dengue-assist";
	final String INTENT_SMART_CHECK_UP = "smart-check-up";
	final String INTENT_WOMENS_HEALTH = "womens-health";
	final String INTENT_LOVE_HEART = "love-heart";
	final String INTENT_DISEASE_DENGUE = "disease-dengue";
	final String INTENT_DISEASE_HIV = "disease-hiv";
	final String INTENT_DISEASE_TB = "disease-tb";
	final String INTENT_SYMPTOMS_DENGUE = "symptoms-dengue";
	final String INTENT_SYMPTOMS_TB = "symptoms-tb";
    ...
    protected void onPostExecute(String retVal) {
        ...
        try {
            ...
            nlcTopic = topClass;
				...
				String faqAPI = Data.DEFAULT_LINK+"/Search.svc/HeyPhilFAQ/?Topic="+topClass;
    ...
    private class loadAPI extends AsyncTask<String, String, String>
    {
        ...
        {
            TestProducts product=new TestProducts();
            String result = "none";
            ...
            if(nlcTopic.contains(INTENT_PROVINCE)){
                ...
                String url = Data.DEFAULT_LINK+"/Search.svc/SearchHospitals/?CertNo="+certificate+"&Type=OP&City=&Hospital";
            ...
            }else if(nlcTopic.contains(INTENT_SHOW_PRODUCTS)){
                Data.avatar="Salesman";
                products=1;
                chatBubbleActivity.updateResult("<ul><li>Dengue Assist</li><br><li>Smart-Checkup</li><br><li>Love Your Heart</li><br><li>Womens Health</li></ul>");
                replyText="1";
            ...
            }else if(nlcTopic.contains(INTENT_DENGUE_ASSIST)){
                Data.item=1;
            description = product.showDengueAssist();
            price = product.priceDengueAssist();
            image = "http://rak-itsolutions.com/api/image/dengue-assist-card.jpg";
                Data.productname="Dengue Assist";
                Data.productname=""+price;
                chatBubbleActivity.updateResult(description);
                replyText="1";
            }else if(nlcTopic.contains(INTENT_SMART_CHECK_UP)){
                Data.item=1;
            description = product.showSmartCheckUp();
            price = product.priceSmartCheckUp();
            image = "http://rak-itsolutions.com/api/image/smartcheckupcard.jpg";
                Data.productname="Smart-CheckUp";
                Data.productname=""+price;
                chatBubbleActivity.updateResult(description);
                replyText="1";
            }else if(nlcTopic.contains(INTENT_LOVE_HEART)){
                Data.item=1;
            description = product.showLoveHeart();
            price = product.priceLoveHeart();
            image = "http://rak-itsolutions.com/api/image/love_your_heart_two.png";
                Data.productname="Love Your Heart";
                Data.productname=""+price;
                chatBubbleActivity.updateResult(description);
                replyText="1";
            }else if(nlcTopic.contains(INTENT_WOMENS_HEALTH)){
                Data.item=1;
            description = product.showWomensLove();
            price = product.priceWomensLove();
            image = "http://rak-itsolutions.com/api/image/womens_health_two.png";
                Data.productname="Womens Love";
                Data.productname=""+price;
                chatBubbleActivity.updateResult(description);
                replyText="1";
            }else if(nlcTopic.contains(INTENT_SYMPTOMS_DENGUE)){
                Data.item=1;
            description = product.symptomsDengue();
            }else if(nlcTopic.contains(INTENT_SYMPTOMS_TB)){
            description = product.symptomsTB();
            }else{
            ...
            if(replyText.equals("0")){
                ...
                if(products==1){
                    chatBubbleActivity.updateResult("Please choose any one this prepaid health cards.");
                }
                else if(Data.item==1){
                    chatBubbleActivity.updateResult("Would you like to buy this prepaid health card?");
                }
            }
        }
    }
