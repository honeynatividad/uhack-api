...
public class Data {
	public static boolean 				android_lower_version;
	public static List<ChatMessage> chatMessageList = new ArrayList<ChatMessage>();
	public static String				DEFAULT_LINK="https://apps.philcare.com.ph/PhilcareWatson";
	...
	public static ArrayList<String> mydoctor = new ArrayList<String>();
	...
	public static boolean Bitmap=false;
	...
	//for edm
	public static boolean clinic;
	public static String urlEDM = "https://apps.philcare.com.ph/MicrositePCareWebServicesTest/CMS.svc/HealthBlogs/?Top=2";
	public static String urlClinic = "https://apps.philcare.com.ph/MicrositePCareWebServicesTest/CMS.svc/ClinicBulletin/?Favorites=000&Top=2";
	//public static String urlEDM = "https://apps.philcare.com.ph/PCareWebServices/CMS.svc/HealthBlogs/?Top=3";
